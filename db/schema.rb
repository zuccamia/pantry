...
ActiveRecord::Schema.define(version: 2021_02_18_131504) do
  ...
  create_table "item_amounts", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_item_amounts_on_user_id"
  end
  ...
  create_table "recipe_amounts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_recipe_amounts_on_item_id"
    t.index ["recipe_id"], name: "index_recipe_amounts_on_recipe_id"
  end
